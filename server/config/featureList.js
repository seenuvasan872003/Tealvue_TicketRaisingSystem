...
const FEATURES = [
  ...
  },
  {
    ...
    "paths": {
      ...
      "team_admin": "/team-admin/categories",
      "user": "/user/categories",
      "team_user": "/team-user/categories"
    },
    "apiPaths": {
      "super-admin": "/api/super-admin/categories",
      "admin": "/api/admin/categories",
      "team_admin": "/api/team-admin/categories",
      "user": "/api/user/categories",
      "team_user": "/api/team-user/categories"
    }
  }
];
