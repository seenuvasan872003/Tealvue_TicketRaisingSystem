    ...
    <div className="space-y-6">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Track and manage your team tickets.</p>
        </div>
      </div>
      ...
      <div className="flex justify-between items-center mb-4 mt-8">
        ...
        <Link to="/team-user/assigned-tickets" className="text-[12px] text-[var(--color-teal)] flex items-center gap-1">View all</Link>
      </div>

      {recent.length === 0 ? (
        <div className="card empty-state p-8 text-center border border-dashed border-white/10 rounded-xl text-white/40">
          No tickets allocated to you yet.
        </div>
      ) : (
